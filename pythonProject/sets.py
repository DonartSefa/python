...
#discard - remove element,if element is not there there will not be any error
set3.discard(5)
print(set3)
...
user2_interests = {"cooking","movies","reading"}
...
set5 = {"Diar","Donart","Filan","Fisteku"}
costumer = "Donart"

print(costumer in set5)
